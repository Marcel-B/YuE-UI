...
const messages = {
  de: {
    ...
    useAsNewSong: 'Als neuer Song',
    showSong: 'Zum Titel',
    songGone: 'Diesen Song gibt es nicht mehr.',
    songActions: 'Weitere Aktionen',
    newSongApplied:
      'Alle Parameter von „{title}“, {song}, stehen im Formular, auch der Seed. „Erzeugen“ macht den Song noch einmal, oder du änderst vorher etwas.',
    ...
    search: 'Suchen',
    searchPlaceholder: 'Titel oder Stil suchen',
    searchLyricsPlaceholder: 'Im Text suchen',
    searchScope: 'Wo gesucht wird',
    searchTitleStyle: 'Titel & Stil',
    searchLyrics: 'Text',
    searchHits: '{count} von {total} Einträgen',
    searchNone: 'Keine Treffer.',
    searchClear: 'Suche leeren',
    rating: 'Bewertung',
    ratingFilter: 'Nach Bewertung filtern',
    ratingAll: 'Alle',
    ratingAtLeast: '★ {n}+',
    ratingOnly: '★ {n}',
    sortBy: 'Sortieren',
    ...
    share: 'Teilen',
    sharePreparing: 'Kleine Datei wird erstellt …',
    shareReady: '„{name}“ ist bereit.',
    shareSave: 'Speichern',
  ...
  en: {
    ...
    useAsNewSong: 'Use as new song',
    showSong: 'Go to song',
    songGone: 'This song no longer exists.',
    songActions: 'More actions',
    newSongApplied:
      'All parameters of “{title}”, {song}, are in the form, the seed too. “Generate” makes the song again, or change something first.',
    ...
    search: 'Search',
    searchPlaceholder: 'Search title or style',
    searchLyricsPlaceholder: 'Search lyrics',
    searchScope: 'Where to search',
    searchTitleStyle: 'Title & style',
    searchLyrics: 'Lyrics',
    searchHits: '{count} of {total} entries',
    ...
    share: 'Share',
    sharePreparing: 'Making a small file …',
    shareReady: '“{name}” is ready.',
    shareSave: 'Save',
